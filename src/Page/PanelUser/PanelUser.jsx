            ...
            <div className='container pt-[50px] pb-[200px]'>
              <div className='flex border h-[400px] border-white/50 rounded-xl'>
                ...
                <div className='border-r border-white/50 text-white flex flex-col py-2 px-2 gap-4'>
                  ...
                  <NavLink onClick={() => setShowLogOut(true)} className="bg-red-500 gap-1 text-[18px]/[30px] hover:bg-red-400   md:px-10 px-4 py-2 rounded-xl transition-all duration-300 flex justify-center items-center"><span className='hidden md:block'>Log Out</span> <HiOutlineLogout /></NavLink>
                </div>
